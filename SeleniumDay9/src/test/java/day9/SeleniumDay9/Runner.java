...
import pageObject.MercuryToursHomePage;
import pageObject.WebDriverUniPage;
...
public class Runner {
	...
	public void createToDo() throws InterruptedException {
		extentTest = extentReports.createTest("Creating a new todo");

		driver.get("https://webdriveruniversity.com/To-Do-List/index.html");
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(25));
		WebDriverUniPage uni = new WebDriverUniPage(driver);
		uni.addToDo("conduct today's class", extentTest);

		Thread.sleep(3000);
	}

	@Test
	public void createToDo2() throws InterruptedException {
		extentTest = extentReports.createTest("Creating a new todo");

		driver.get("https://webdriveruniversity.com/To-Do-List/index.html");
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(25));
		WebDriverUniPage uni = new WebDriverUniPage(driver);
		uni.addToDo2("conduct today's class", extentTest);
	...
	public void verifyLogin() throws InterruptedException {
		extentTest = extentReports.createTest("Verifying login process");
